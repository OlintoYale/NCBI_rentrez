...
Searches can be make using one or several fields combined using logical operator, for example the script GenBank_rentrez_window.R us the following search fields:
